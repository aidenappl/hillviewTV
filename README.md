...
> ⚠️ **DEPRECATED**: This project is no longer actively maintained. The codebase uses Angular 12 which has known security vulnerabilities and is significantly outdated. This repository is kept for archival purposes only.
